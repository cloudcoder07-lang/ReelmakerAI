...
class ZoomEditorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnExport.setOnClickListener {
            Toast.makeText(this, "Export Zoom", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun injectZoomControls() {
        val zoomControls = layoutInflater.inflate(R.layout.view_zoom_controls, toolControlContainer, false)
        toolControlContainer.addView(zoomControls)
    }
}
